...
function Register() {
  ...
  const handleGoogleSignup = () => {
    ...
    const redirectUri = "https://5816-102-215-34-58.in.ngrok.io/properties";
    window.location.href = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${clientId}&redirect_uri=${redirectUri}&response_type=code&scope=openid%20email`;
  };
      ...
      <div id="sec">
        ...
        <div className="sec-main">
          ...
          <form className="registration" onSubmit={handleSubmit}>
            ...
            <Link to="/landlordRegister">Landlord?Sign up as the Landlord</Link>
          </form>
        </div>
      </div>
    </>
